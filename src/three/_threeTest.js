...
function init() {
  ...
  console.log(scene.add(createLights()));
  ...
  const AnimateBox = () => {
    ...
    // console.log(this.p_light);
    // console.log(camera.position);
    mesh.rotation.x = Math.cos(alepsedTime / 12);
    mesh.rotation.y = Math.sin(alepsedTime);
    camera.position.y = Math.cos(alepsedTime * Math.sin(alepsedTime));
  ...
  renderer.setPixelRatio(pixelDevice);
  // orbitControls.addEventListener("change", AnimateBox());
